...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(Vector vector, Hashtable hashtable) {
        ...
        while (keys.hasMoreElements()) {
            this.ordering.addElement(DERObjectIdentifier.getInstance(keys.nextElement()));
        }
        Enumeration elements = this.ordering.elements();
        while (elements.hasMoreElements()) {
            ASN1ObjectIdentifier instance = DERObjectIdentifier.getInstance(elements.nextElement());
