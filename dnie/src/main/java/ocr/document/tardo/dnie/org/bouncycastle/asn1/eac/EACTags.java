...
public class EACTags {
    ...
    public static int decodeTag(int i) {
        ...
        for (int i4 = 24; i4 >= 0; i4 -= 8) {
            ...
            if (i5 != 0) {
                if (i3 != 0) {
                    i2 = (i2 << 7) | (i5 & CertificateBody.profileType);
                } else if ((i5 & 31) != 31) {
                    return i5 & 31;
                } else {
                    i3 = 1;
    ...
    public static int encodeTag(DERApplicationSpecific dERApplicationSpecific) {
        ...
        i = (applicationTag & CertificateBody.profileType) | ((i | 31) << 8);
        int i2 = applicationTag >> 7;
        while (i2 > 0) {
            applicationTag = (i | 128) << 8;
            i = i2 & CertificateBody.profileType;
            i2 >>= 7;
            i = applicationTag;
        }
        return i;
