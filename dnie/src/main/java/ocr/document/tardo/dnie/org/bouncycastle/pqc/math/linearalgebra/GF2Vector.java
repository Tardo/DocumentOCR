...
public class GF2Vector extends Vector {
    ...
    public GF2Vector(int i, SecureRandom secureRandom) {
        ...
        this.length = i;
        int i3 = (i + 31) >> 5;
        this.f345v = new int[i3];
        for (i2 = i3 - 1; i2 >= 0; i2--) {
            this.f345v[i2] = secureRandom.nextInt();
        }
        i2 = i & 31;
        if (i2 != 0) {
            int[] iArr = this.f345v;
    ...
    public GF2Vector(int i, int[] iArr) {
        ...
        this.f345v = IntUtils.clone(iArr);
        int i3 = i & 31;
        if (i3 != 0) {
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f345v = IntUtils.clone(gF2Vector.f345v);
    }
    ...
    public Vector add(Vector vector) {
        if (vector instanceof GF2Vector) {
            ...
            int[] clone = IntUtils.clone(((GF2Vector) vector).f345v);
            for (int length = clone.length - 1; length >= 0; length--) {
                clone[length] = clone[length] ^ this.f345v[length];
            }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f345v, gF2Vector.f345v);
    }
    ...
    public GF2Vector extractLeftVector(int i) {
        if (i > this.length) {
            ...
            int i2 = i >> 5;
            int i3 = i & 31;
            System.arraycopy(this.f345v, 0, gF2Vector.f345v, 0, i2);
            if (i3 == 0) {
                return gF2Vector;
            }
            gF2Vector.f345v[i2] = ((1 << i3) - 1) & this.f345v[i2];
            return gF2Vector;
        }
    }
    ...
    public GF2Vector extractRightVector(int i) {
        ...
        if (i > this.length) {
            ...
            if (i4 != 0) {
                while (i2 < i5 - 1) {
                    int i6 = i3 + 1;
                    gF2Vector.f345v[i2] = (this.f345v[i3] >>> i4) | (this.f345v[i6] << (32 - i4));
                    i2++;
                    i3 = i6;
                }
                int i7 = i3 + 1;
                gF2Vector.f345v[i5 - 1] = this.f345v[i3] >>> i4;
                if (i7 >= this.f345v.length) {
                    return gF2Vector;
                }
                int[] iArr = gF2Vector.f345v;
                i3 = i5 - 1;
                iArr[i3] = iArr[i3] | (this.f345v[i7] << (32 - i4));
                return gF2Vector;
            }
            System.arraycopy(this.f345v, i3, gF2Vector.f345v, 0, i5);
            return gF2Vector;
        }
    }
    ...
    public GF2Vector extractVector(int[] iArr) {
        ...
        for (int i = 0; i < length; i++) {
            if ((this.f345v[iArr[i] >> 5] & (1 << (iArr[i] & 31))) != 0) {
                int[] iArr2 = gF2Vector.f345v;
                int i2 = i >> 5;
    ...
    public int getBit(int i) {
        ...
        int i2 = i & 31;
        return (this.f345v[i >> 5] & (1 << i2)) >>> i2;
    }

    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f345v, (this.length + 7) >> 3);
    }

    public int getHammingWeight() {
        int i = 0;
        for (int i2 : this.f345v) {
    ...
    public int hashCode() {
        return (this.length * 31) + this.f345v.hashCode();
    }

    public boolean isZero() {
        for (int length = this.f345v.length - 1; length >= 0; length--) {
    ...
    public Vector multiply(Permutation permutation) {
        ...
        for (int i = 0; i < vector.length; i++) {
            if ((this.f345v[vector[i] >> 5] & (1 << (vector[i] & 31))) != 0) {
                int[] iArr = gF2Vector.f345v;
                int i2 = i >> 5;
