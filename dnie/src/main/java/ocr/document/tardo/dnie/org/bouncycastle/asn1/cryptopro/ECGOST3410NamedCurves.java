...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchA, new ECDomainParameters(fp, new ECPoint.Fp(fp, new ECFieldElement.Fp(fp.getQ(), new BigInteger("1")), new ECFieldElement.Fp(fp.getQ(), new BigInteger("64033881142927202683649881450433473985931760268884941288852745803908878638612"))), bigInteger2));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_B, new ECDomainParameters(fp, new ECPoint.Fp(fp, new ECFieldElement.Fp(bigInteger, new BigInteger("1")), new ECFieldElement.Fp(bigInteger, new BigInteger("28792665814854611296992347458380284135028636778229113005756334730996303888124"))), bigInteger2));
        ...
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_XchB, new ECDomainParameters(fp, new ECPoint.Fp(fp, new ECFieldElement.Fp(bigInteger, new BigInteger("0")), new ECFieldElement.Fp(bigInteger, new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247"))), bigInteger2));
        bigInteger = new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502619");
        bigInteger2 = new BigInteger("70390085352083305199547718019018437840920882647164081035322601458352298396601");
        fp = new Fp(bigInteger, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"));
        params.put(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_C, new ECDomainParameters(fp, new ECPoint.Fp(fp, new ECFieldElement.Fp(bigInteger, new BigInteger("0")), new ECFieldElement.Fp(bigInteger, new BigInteger("29818893917731240733471273240314769927240550812383695689146495261604565990247"))), bigInteger2));
