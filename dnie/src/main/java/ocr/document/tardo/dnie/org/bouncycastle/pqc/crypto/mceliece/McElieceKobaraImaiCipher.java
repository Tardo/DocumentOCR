...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        ...
        this.f320n = mcElieceCCA2PublicKeyParameters.getN();
        this.f319k = mcElieceCCA2PublicKeyParameters.getK();
        this.f321t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f320n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f319k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f321t = mcElieceCCA2PrivateKeyParameters.getT();
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) throws Exception {
        ...
        GF2Vector[] decryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f320n, bArr));
        bArr2 = decryptionPrimitive[0].getEncoded();
        GF2Vector gF2Vector = decryptionPrimitive[1];
        if (bArr2.length > i2) {
            bArr2 = ByteUtils.subArray(bArr2, 0, i2);
        }
        bArr2 = ByteUtils.concatenate(ByteUtils.concatenate(bArr3, Conversions.decode(this.f320n, this.f321t, gF2Vector)), bArr2);
    ...
    public byte[] messageEncrypt(byte[] bArr) throws Exception {
        int digestSize = this.messDigest.getDigestSize();
        int i = this.f319k >> 3;
        int bitLength = (IntegerFunctions.binomial(this.f320n, this.f321t).bitLength() - 1) >> 3;
        ...
        bArr5 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f319k, obj), Conversions.encode(this.f320n, this.f321t, obj2)).getEncoded();
