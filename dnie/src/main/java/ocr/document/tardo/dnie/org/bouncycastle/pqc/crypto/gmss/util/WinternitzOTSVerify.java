...
public class WinternitzOTSVerify {
    ...
    public byte[] Verify(byte[] bArr, byte[] bArr2) {
        ...
        int i = ((digestSize << 3) + (this.f127w - 1)) / this.f127w;
        int log = getLog((i << this.f127w) + 1);
        int i2 = ((((this.f127w + log) - 1) / this.f127w) + i) * digestSize;
        if (i2 != bArr2.length) {
            return null;
        }
        ...
        if (8 % this.f127w == 0) {
            ...
            for (i2 = 0; i2 < bArr4.length; i2++) {
                ...
                while (i7 < i5) {
                    ...
                    bArr4[i2] = (byte) (bArr4[i2] >>> this.f127w);
                    i7++;
                    i4++;
                    i3 = i9;
                }
        ...
        } else if (this.f127w < 8) {
            r18 = digestSize / this.f127w;
            r19 = (1 << this.f127w) - 1;
        ...
        } else if (this.f127w < 57) {
            long j2;
            r18 = (digestSize << 3) - this.f127w;
            r19 = (1 << this.f127w) - 1;
            i8 = 0;
    ...
    public int getSignatureLength() {
        int digestSize = this.messDigestOTS.getDigestSize();
        int i = ((digestSize << 3) + (this.f127w - 1)) / this.f127w;
        return digestSize * (i + (((getLog((i << this.f127w) + 1) + this.f127w) - 1) / this.f127w));
    }
}
