...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: x */
    private BigInteger f293x;

    protected BCDHPrivateKey() {
    }

    BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f293x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f293x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        this.f293x = aSN1Integer.getValue();
    ...
    BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f293x = dHPrivateKeyParameters.getX();
    ...
    public byte[] getEncoded() {
        try {
            return this.info != null ? this.info.getEncoded("DER") : new PrivateKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL()).toASN1Primitive()), new ASN1Integer(getX())).getEncoded("DER");
        } catch (Exception e) {
            return null;
        }
    }
