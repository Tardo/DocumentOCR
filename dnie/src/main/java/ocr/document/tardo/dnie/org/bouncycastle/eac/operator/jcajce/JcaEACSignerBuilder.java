...
public class JcaEACSignerBuilder {
    ...
    static {
        sigNames.put(DnieProvider.SHA1WITH_RSA, EACObjectIdentifiers.id_TA_RSA_v1_5_SHA_1);
    ...
    private static byte[] reencode(byte[] bArr) {
        ...
        BigInteger value = DERInteger.getInstance(instance.getObjectAt(0)).getValue();
        BigInteger value2 = DERInteger.getInstance(instance.getObjectAt(1)).getValue();
                ...
                public byte[] getSignature() {
                    try {
                        ...
                        if (aSN1ObjectIdentifier.on(EACObjectIdentifiers.id_TA_ECDSA)) {
                            signature = JcaEACSignerBuilder.reencode(signature);
                        }
                        return signature;
                    } catch (Throwable e) {
