...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f523n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f522k = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public static McElieceCCA2PrivateKey getInstance(Object obj) {
        return obj instanceof McElieceCCA2PrivateKey ? (McElieceCCA2PrivateKey) obj : obj != null ? new McElieceCCA2PrivateKey(ASN1Sequence.getInstance(obj)) : null;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f523n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f522k));
