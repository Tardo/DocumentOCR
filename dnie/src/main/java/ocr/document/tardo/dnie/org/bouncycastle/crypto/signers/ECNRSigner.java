...
public class ECNRSigner implements DSA {
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        if (bigInteger3.bitLength() > bitLength) {
            ...
            ECPoint sumOfTwoMultiplies = ECAlgorithms.sumOfTwoMultiplies(eCPublicKeyParameters.getParameters().getG(), bigInteger2, eCPublicKeyParameters.getQ(), bigInteger);
            return sumOfTwoMultiplies.isInfinity() ? false : bigInteger.subtract(sumOfTwoMultiplies.getX().toBigInteger()).mod(n).equals(bigInteger3);
        }
    }
}
