...
public class X9FieldElement extends ASN1Object {
    ...
    /* renamed from: f */
    protected ECFieldElement f477f;
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DEROctetString(converter.integerToBytes(this.f477f.toBigInteger(), converter.getByteLength(this.f477f)));
    }
}
