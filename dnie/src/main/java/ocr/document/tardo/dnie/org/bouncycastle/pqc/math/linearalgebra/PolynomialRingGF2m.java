...
public class PolynomialRingGF2m {
    ...
    /* renamed from: p */
    private PolynomialGF2mSmallM f150p;
    ...
    public PolynomialRingGF2m(GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM) {
        ...
        this.f150p = polynomialGF2mSmallM;
    ...
    private void computeSquareRootMatrix() {
        int i;
        int degree = this.f150p.getDegree();
    ...
    private void computeSquaringMatrix() {
        ...
        for (i = degree >> 1; i < degree; i++) {
            iArr = new int[((i << 1) + 1)];
            iArr[i << 1] = 1;
            this.sqMatrix[i] = new PolynomialGF2mSmallM(this.field, iArr).mod(this.f150p);
        }
    }
