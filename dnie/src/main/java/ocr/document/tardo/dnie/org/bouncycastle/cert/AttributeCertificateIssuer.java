    ...
    public boolean match(Object obj) {
        ...
        if (this.form instanceof V2Form) {
            ...
            if (v2Form.getBaseCertificateID() != null) {
                boolean z = v2Form.getBaseCertificateID().getSerial().getValue().equals(x509CertificateHolder.getSerialNumber()) && matchesDN(x509CertificateHolder.getIssuer(), v2Form.getBaseCertificateID().getIssuer());
                return z;
            }
