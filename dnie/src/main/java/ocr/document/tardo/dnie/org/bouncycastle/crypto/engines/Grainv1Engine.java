...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutputLFSR() {
        ...
        return (((((this.lfsr[0] ^ ((this.lfsr[0] >>> 13) | (this.lfsr[1] << 3))) ^ i) ^ i2) ^ i3) ^ ((this.lfsr[3] >>> 14) | (this.lfsr[4] << 2))) & 65535;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (i < this.nfsr.length) {
            this.nfsr[i] = ((this.workingKey[i2 + 1] << 8) | (this.workingKey[i2] & 255)) & 65535;
            this.lfsr[i] = ((this.workingIV[i2 + 1] << 8) | (this.workingIV[i2] & 255)) & 65535;
            i2 += 2;
            i++;
        }
    }
