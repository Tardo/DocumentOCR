...
public class WinternitzOTSignature {
    ...
    public byte[] getSignature(byte[] bArr) {
        ...
        if (8 % this.f128w == 0) {
            ...
            for (i5 = 0; i5 < bArr3.length; i5++) {
                ...
                while (i6 < i3) {
                    ...
                    bArr3[i5] = (byte) (bArr3[i5] >>> this.f128w);
                    i++;
                    i6++;
                    i2 = i8;
                }
            }
            i2 = (this.messagesize << this.f128w) - i2;
            i5 = 0;
        ...
        } else if (this.f128w < 8) {
            r15 = this.mdsize / this.f128w;
            r16 = (1 << this.f128w) - 1;
            ...
            i2 = (this.messagesize << this.f128w) - i8;
            i5 = 0;
            while (i5 < this.checksumsize) {
                System.arraycopy(this.privateKeyOTS[i], 0, obj2, 0, this.mdsize);
        ...
        } else if (this.f128w < 57) {
            i4 = (this.mdsize << 3) - this.f128w;
            r15 = (1 << this.f128w) - 1;
            r8 = new byte[this.mdsize];
            r5 = 0;
            i6 = 0;
            ...
            i = (this.messagesize << this.f128w) - r5;
            obj2 = r4;
            i5 = 0;
            int i9 = i;
            i = i2;
