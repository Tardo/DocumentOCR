...
class Tnaf {
    ...
    public static BigInteger norm(byte b, ZTauElement zTauElement) {
        BigInteger multiply = zTauElement.f116u.multiply(zTauElement.f116u);
        BigInteger multiply2 = zTauElement.f116u.multiply(zTauElement.f117v);
        BigInteger shiftLeft = zTauElement.f117v.multiply(zTauElement.f117v).shiftLeft(1);
        if (b == (byte) 1) {
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i, byte b, BigInteger[] bigIntegerArr, byte b2, byte b3) {
        ...
        return new ZTauElement(bigInteger.subtract(add.multiply(round.f116u)).subtract(BigInteger.valueOf(2).multiply(bigIntegerArr[1]).multiply(round.f117v)), bigIntegerArr[1].multiply(round.f116u).subtract(bigIntegerArr[0].multiply(round.f117v)));
    }
    ...
    public static byte[] tauAdicNaf(byte b, ZTauElement zTauElement) {
        if (b == (byte) 1 || b == (byte) -1) {
            ...
            BigInteger bigInteger = zTauElement.f116u;
            BigInteger bigInteger2 = zTauElement.f117v;
            int i = 0;
            int i2 = 0;
            while (true) {
    ...
    public static byte[] tauAdicWNaf(byte b, ZTauElement zTauElement, byte b2, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        if (b == (byte) 1 || b == (byte) -1) {
            ...
            BigInteger bigInteger3 = zTauElement.f116u;
            BigInteger bigInteger4 = zTauElement.f117v;
            bitLength = 0;
            while (true) {
                ...
                if (bigInteger3.testBit(0)) {
                    ...
                    if (intValue != (byte) 0) {
                        bigInteger3 = bigInteger3.subtract(zTauElementArr[i].f116u);
                        bigInteger4 = bigInteger4.subtract(zTauElementArr[i].f117v);
                    } else {
                        bigInteger3 = bigInteger3.add(zTauElementArr[i].f116u);
                        bigInteger4 = bigInteger4.add(zTauElementArr[i].f117v);
                    }
                    mod = bigInteger3;
                } else {
