    ...
    private int[] parseIPv6(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (nextToken.equals(":")) {
                ...
                i = i3 + 1;
                obj[i3] = Integer.parseInt(nextToken, 16);
                ...
                int i5 = i3 + 1;
                obj[i3] = (Integer.parseInt(stringTokenizer2.nextToken()) << 8) | Integer.parseInt(stringTokenizer2.nextToken());
                i3 = i5 + 1;
                obj[i5] = Integer.parseInt(stringTokenizer2.nextToken()) | (Integer.parseInt(stringTokenizer2.nextToken()) << 8);
            }
        }
        if (i3 != obj.length) {
            System.arraycopy(obj, i2, obj, obj.length - (i3 - i2), i3 - i2);
            for (i = i2; i != obj.length - (i3 - i2); i++) {
                obj[i] = null;
            }
        }
        return obj;
