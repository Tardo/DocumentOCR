...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    class C01031 implements PrivilegedAction {
        C01031() {
        }
    ...
    public BouncyCastleProvider() {
        ...
        AccessController.doPrivileged(new C01031());
    }
    ...
    private void addMacAlgorithms() {
        ...
        addHMACAlgorithm(McElieceCCA2ParameterSpec.DEFAULT_MD, PROVIDER_PACKAGE_NAME + ".JCEMac$SHA256", PROVIDER_PACKAGE_NAME + ".JCEKeyGenerator$HMACSHA256");
        addHMACAlias(McElieceCCA2ParameterSpec.DEFAULT_MD, PKCSObjectIdentifiers.id_hmacWithSHA256);
    ...
    private void addSignatureAlgorithms() {
        ...
        addSignatureAlgorithm(McElieceCCA2ParameterSpec.DEFAULT_MD, "DSA", PROVIDER_PACKAGE_NAME + ".JDKDSASigner$dsa256", NISTObjectIdentifiers.dsa_with_sha256);
