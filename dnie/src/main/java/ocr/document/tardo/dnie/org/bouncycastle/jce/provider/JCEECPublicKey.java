...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private ECPoint f514q;
    private boolean withCompression;

    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = str;
        this.ecSpec = eCPublicKeySpec.getParams();
        this.f514q = EC5Util.convertPoint(this.ecSpec, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f514q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f514q = jCEECPublicKey.f514q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = str;
        this.f514q = eCPublicKeySpec.getQ();
        ...
        if (this.f514q.getCurve() == null) {
            this.f514q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f514q.getX().toBigInteger(), this.f514q.getY().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.f514q = EC5Util.convertPoint(this.ecSpec, eCPublicKey.getW(), false);
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        if (subjectPublicKeyInfo.getAlgorithmId().getObjectId().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f514q = curve.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f514q = new X9ECPoint(eCCurve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger toBigInteger = this.f514q.getX().toBigInteger();
            BigInteger toBigInteger2 = this.f514q.getY().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f514q instanceof Fp ? new Fp(null, this.f514q.getX(), this.f514q.getY()) : new F2m(null, this.f514q.getX(), this.f514q.getY()) : this.f514q;
    }

    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f514q.getX().toBigInteger(), this.f514q.getY().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("            X: ").append(this.f514q.getX().toBigInteger().toString(16)).append(property);
        stringBuffer.append("            Y: ").append(this.f514q.getY().toBigInteger().toString(16)).append(property);
