...
public class OtherRevocationInfoFormat extends ASN1Object {
    ...
    private OtherRevocationInfoFormat(ASN1Sequence aSN1Sequence) {
        this.otherRevInfoFormat = DERObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0));
        this.otherRevInfo = aSN1Sequence.getObjectAt(1);
    }

    public static OtherRevocationInfoFormat getInstance(Object obj) {
        return obj instanceof OtherRevocationInfoFormat ? (OtherRevocationInfoFormat) obj : obj != null ? new OtherRevocationInfoFormat(ASN1Sequence.getInstance(obj)) : null;
    }
