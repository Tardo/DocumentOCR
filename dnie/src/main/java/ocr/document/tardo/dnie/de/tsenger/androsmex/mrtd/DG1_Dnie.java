...
public class DG1_Dnie {
    ...
    public DG1_Dnie(byte[] rawBytes) {
        ...
        mrz1 = mrzString.substring(0, 30);
        mrz2 = mrzString.substring(30, 60);
    ...
    public String getNationality() {
        return (String) this.countryNames.get(this.nationality);
    }
    ...
    public String getIssuer() {
        return (String) this.countryNames.get(this.issuer);
    }
