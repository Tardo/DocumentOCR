...
public final class MrtdKeyStoreImpl extends KeyStoreSpi {
    ...
    public String engineGetCertificateAlias(Certificate cert) {
        ...
        for (String alias : USERS_CERTS_ALIASES) {
            if (((X509Certificate) engineGetCertificate(alias)).getSerialNumber().compareTo(serial) == 0) {
                return alias;
            }
        }
        return null;
    ...
    public Key engineGetKey(String alias, char[] password) throws NoSuchAlgorithmException, UnrecoverableKeyException {
        ...
        try {
            ...
            if (pkRef instanceof DnieMrtdPrivateKeyReference) {
                return new MrtdPrivateKey((DnieMrtdPrivateKeyReference) pkRef);
            }
    ...
    public void engineLoad(LoadStoreParameter param) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        this.cryptoCard = new DnieMrtd(tagNFC != null ? new SmartCardMRTDConnection(IsoDep.get(tagNFC), ((DnieProvider) Security.getProvider("DNIeJCAProvider")).getProviderCan()) : new SmartcardIoConnection(), null, new JseCryptoHelper());
    }
    ...
    public final EF_COM getEFCOM() {
        try {
            return this.cryptoCard.getEFCOM();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
    ...
    public final DG1_Dnie getDataGroup1() {
        try {
            return this.cryptoCard.getDataGroup1();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
    ...
    public final DG2 getDataGroup2() {
        try {
            return this.cryptoCard.getDataGroup2();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
    ...
    public final DG7 getDataGroup7() {
        try {
            return this.cryptoCard.getDataGroup7();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
    ...
    public final DG11 getDataGroup11() {
        try {
            return this.cryptoCard.getDataGroup11();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
    ...
    public final DG13 getDataGroup13() {
        try {
            return this.cryptoCard.getDataGroup13();
        } catch (CryptoCardException e) {
            throw new ProviderException(e.getMessage());
        }
    }
