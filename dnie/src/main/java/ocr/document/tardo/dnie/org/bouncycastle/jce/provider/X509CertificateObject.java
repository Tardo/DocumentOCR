...
public class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    private void checkSignature(PublicKey publicKey, Signature signature) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
        if (isAlgIdEqual(this.f300c.getSignatureAlgorithm(), this.f300c.getTBSCertificate().getSignature())) {
            X509SignatureUtil.setSignatureParameters(signature, this.f300c.getSignatureAlgorithm().getParameters());
    ...
    private byte[] getExtensionBytes(String str) {
        Extensions extensions = this.f300c.getTBSCertificate().getExtensions();
        if (extensions != null) {
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        if (date.getTime() > getNotAfter().getTime()) {
            throw new CertificateExpiredException("certificate expired on " + this.f300c.getEndDate().getTime());
        } else if (date.getTime() < getNotBefore().getTime()) {
            throw new CertificateNotYetValidException("certificate not valid till " + this.f300c.getStartDate().getTime());
        }
    }
    ...
    public byte[] getEncoded() throws CertificateEncodingException {
        try {
            return this.f300c.getEncoded("DER");
        } catch (IOException e) {
    ...
    public Principal getIssuerDN() {
        try {
            return new X509Principal(X500Name.getInstance(this.f300c.getIssuer().getEncoded()));
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public boolean[] getIssuerUniqueID() {
        DERBitString issuerUniqueId = this.f300c.getTBSCertificate().getIssuerUniqueId();
    ...
    public X500Principal getIssuerX500Principal() {
        try {
            ...
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f300c.getIssuer());
    ...
    public Date getNotAfter() {
        return this.f300c.getEndDate().getDate();
    }

    public Date getNotBefore() {
        return this.f300c.getStartDate().getDate();
    }

    public PublicKey getPublicKey() {
        try {
            return BouncyCastleProvider.getPublicKey(this.f300c.getSubjectPublicKeyInfo());
        } catch (IOException e) {
            return null;
        }
    }
    ...
    public BigInteger getSerialNumber() {
        return this.f300c.getSerialNumber().getValue();
    }
    ...
    public String getSigAlgOID() {
        return this.f300c.getSignatureAlgorithm().getAlgorithm().getId();
    }

    public byte[] getSigAlgParams() {
        byte[] bArr = null;
        if (this.f300c.getSignatureAlgorithm().getParameters() != null) {
            try {
                bArr = this.f300c.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded("DER");
            } catch (IOException e) {
            }
        }
        return bArr;
    ...
    public byte[] getSignature() {
        return this.f300c.getSignature().getBytes();
    }
    ...
    public Principal getSubjectDN() {
        return new X509Principal(X500Name.getInstance(this.f300c.getSubject().toASN1Primitive()));
    }

    public boolean[] getSubjectUniqueID() {
        DERBitString subjectUniqueId = this.f300c.getTBSCertificate().getSubjectUniqueId();
    ...
    public X500Principal getSubjectX500Principal() {
        try {
            OutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            new ASN1OutputStream(byteArrayOutputStream).writeObject(this.f300c.getSubject());
            return new X500Principal(byteArrayOutputStream.toByteArray());
        } catch (IOException e) {
            throw new IllegalStateException("can't encode issuer DN");
        }
    ...
    public byte[] getTBSCertificate() throws CertificateEncodingException {
        try {
            return this.f300c.getTBSCertificate().getEncoded("DER");
        } catch (IOException e) {
            throw new CertificateEncodingException(e.toString());
        }
    }
    ...
    public int getVersion() {
        return this.f300c.getVersionNumber();
    }
    ...
    public final void verify(PublicKey publicKey) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        Signature instance;
        String signatureName = X509SignatureUtil.getSignatureName(this.f300c.getSignatureAlgorithm());
        try {
    ...
    public final void verify(PublicKey publicKey, String str) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
        checkSignature(publicKey, Signature.getInstance(X509SignatureUtil.getSignatureName(this.f300c.getSignatureAlgorithm()), str));
    }
}
