    ...
    public boolean match(Certificate certificate) {
        ...
        try {
            if (this.holder.getBaseCertificateID() != null) {
                boolean z = this.holder.getBaseCertificateID().getSerial().getValue().equals(x509Certificate.getSerialNumber()) && matchesDN(PrincipalUtil.getIssuerX509Principal(x509Certificate), this.holder.getBaseCertificateID().getIssuer());
                return z;
