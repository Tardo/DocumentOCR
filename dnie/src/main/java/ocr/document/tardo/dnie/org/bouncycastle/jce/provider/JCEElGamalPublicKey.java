...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f516y = ((DERInteger) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f516y = elGamalPublicKeyParameters.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f516y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new DERInteger(this.f516y));
    }
