...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp112r1 = new C02061();
    static X9ECParametersHolder secp112r2 = new C02072();
    static X9ECParametersHolder secp128r1 = new C02083();
    static X9ECParametersHolder secp128r2 = new C02094();
    static X9ECParametersHolder secp160k1 = new C02105();
    static X9ECParametersHolder secp160r1 = new C02116();
    static X9ECParametersHolder secp160r2 = new C02127();
    static X9ECParametersHolder secp192k1 = new C02138();
    static X9ECParametersHolder secp192r1 = new C02149();
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), n, h, null);
        }
    };
    static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34")), n, h, S);
        }
    };
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8")), n, h, null);
        }
    };
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("046B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5")), n, h, S);
        }
    };
    static X9ECParametersHolder secp384r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB73617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F")), n, h, S);
        }
    };
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = new F2m(113, 9, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04009D73616F35F4AB1407D73562C10F00A52830277958EE84D1315ED31886")), n, h, S);
        }
    };
    static X9ECParametersHolder sect113r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(113, 9, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0401A57A6A7B26CA5EF52FCDB816479700B3ADC94ED1FE674C06E695BABA1D")), n, h, S);
        }
    };
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(131, 2, 3, 8, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150")), n, h, S);
        }
    };
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(131, 2, 3, 8, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F")), n, h, S);
        }
    };
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9")), n, h, null);
        }
    };
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("040369979697AB43897789566789567F787A7876A65400435EDB42EFAFB2989D51FEFCE3C80988F41FF883")), n, h, S);
        }
    };
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0403F0EBA16286A2D57EA0991168D4994637E8343E3600D51FBC6C71A0094FA2CDD545B11C5C0C797324F1")), n, h, S);
        }
    };
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(193, 15, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0401F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E10025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05")), n, h, S);
        }
    };
    static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(193, 15, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0400D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C")), n, h, S);
        }
    };
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = new F2m(233, 74, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3")), n, h, null);
        }
    };
    static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(233, 74, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0400FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B01006A08A41903350678E58528BEBF8A0BEFF867A7CA36716F7E01F81052")), n, h, S);
        }
    };
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new F2m(239, (int) CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA")), n, h, null);
        }
    };
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new F2m(283, 5, 7, 12, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259")), n, h, null);
        }
    };
    static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(283, 5, 7, 12, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0405F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B1205303676854FE24141CB98FE6D4B20D02B4516FF702350EDDB0826779C813F0DF45BE8112F4")), n, h, S);
        }
    };
    static X9ECParametersHolder sect409k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new F2m(409, 87, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("040060F05F658F49C1AD3AB1890F7184210EFD0987E307C84C27ACCFB8F9F67CC2C460189EB5AAAA62EE222EB1B35540CFE902374601E369050B7C4E42ACBA1DACBF04299C3460782F918EA427E6325165E9EA10E3DA5F6C42E9C55215AA9CA27A5863EC48D8E0286B")), n, h, null);
        }
    };
    static X9ECParametersHolder sect409r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = new F2m(409, 87, a, b, n, h);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04015D4860D088DDB3496B0C6064756260441CDE4AF1771D4DB01FFE5B34E59703DC255A868A1180515603AEAB60794E54BB7996A70061B1CFAB6BE5F32BBFA78324ED106A7636B9C5A7BD198D0158AA4F5488D08F38514F1FDF4B4F40D2181B3681C364BA0273C706")), n, h, S);
        }
    };
    static X9ECParametersHolder sect571k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new F2m(571, 2, 5, 10, a, b, n, h);
    ...
    static class C02061 extends X9ECParametersHolder {
        C02061() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0409487239995A5EE76B55F9C2F098A89CE5AF8724C0A23E0E0FF77500")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$2 */
    static class C02072 extends X9ECParametersHolder {
        C02072() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("044BA30AB5E892B4E1649DD0928643ADCD46F5882E3747DEF36E956E97")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$3 */
    static class C02083 extends X9ECParametersHolder {
        C02083() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04161FF7528B899B2D0C28607CA52C5B86CF5AC8395BAFEB13C02DA292DDED7A83")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$4 */
    static class C02094 extends X9ECParametersHolder {
        C02094() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(4);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("047B6AA5D85E572983E6FB32A7CDEBC14027B6916A894D3AEE7106FE805FC34B44")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$5 */
    static class C02105 extends X9ECParametersHolder {
        C02105() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("043B4C382CE37AA192A4019E763036F4F5DD4D7EBB938CF935318FDCED6BC28286531733C3F03C4FEE")), n, h, null);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$6 */
    static class C02116 extends X9ECParametersHolder {
        C02116() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("044A96B5688EF573284664698968C38BB913CBFC8223A628553168947D59DCC912042351377AC5FB32")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$7 */
    static class C02127 extends X9ECParametersHolder {
        C02127() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("0452DCB034293A117E1F4FF11B30F7199D3144CE6DFEAFFEF2E331F296E071FA0DF9982CFEA7D43F2E")), n, h, S);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$8 */
    static class C02138 extends X9ECParametersHolder {
        C02138() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), n, h, null);
        }
    }

    /* renamed from: org.spongycastle.asn1.sec.SECNamedCurves$9 */
    static class C02149 extends X9ECParametersHolder {
        C02149() {
        }
        ...
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = new Fp(p, a, b);
            return new X9ECParameters(curve, curve.decodePoint(Hex.decode("04188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF101207192B95FFC8DA78631011ED6B24CDD573F977A11E794811")), n, h, S);
        }
    }
