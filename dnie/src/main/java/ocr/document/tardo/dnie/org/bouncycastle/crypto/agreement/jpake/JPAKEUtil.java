...
public class JPAKEUtil {
    ...
    public static BigInteger[] calculateZeroKnowledgeProof(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5, String str, Digest digest, SecureRandom secureRandom) {
        ...
        BigInteger calculateHashForZeroKnowledgeProof = calculateHashForZeroKnowledgeProof(bigInteger3, modPow, bigInteger4, str, digest);
        bigIntegerArr[0] = modPow;
        bigIntegerArr[1] = createRandomInRange.subtract(bigInteger5.multiply(calculateHashForZeroKnowledgeProof)).mod(bigInteger2);
    ...
    private static void updateDigest(Digest digest, String str) {
        byte[] toUTF8ByteArray = Strings.toUTF8ByteArray(str);
        digest.update(toUTF8ByteArray, 0, toUTF8ByteArray.length);
    ...
    private static void updateDigestIncludingSize(Digest digest, String str) {
        byte[] toUTF8ByteArray = Strings.toUTF8ByteArray(str);
        digest.update(intToByteArray(toUTF8ByteArray.length), 0, 4);
        digest.update(toUTF8ByteArray, 0, toUTF8ByteArray.length);
        Arrays.fill(toUTF8ByteArray, (byte) 0);
    }
    ...
    private static void updateMac(Mac mac, String str) {
        byte[] toUTF8ByteArray = Strings.toUTF8ByteArray(str);
        mac.update(toUTF8ByteArray, 0, toUTF8ByteArray.length);
        Arrays.fill(toUTF8ByteArray, (byte) 0);
    }
