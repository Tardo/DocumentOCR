...
public class SerpentEngine implements BlockCipher {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        this.X1 ^= this.wKey[EACTags.CARDHOLDER_RELATIVE_DATA];
        this.X2 ^= this.wKey[EACTags.CARD_DATA];
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        LT();
        sb1(this.wKey[100] ^ this.X0, this.wKey[EACTags.CARDHOLDER_RELATIVE_DATA] ^ this.X1, this.wKey[EACTags.CARD_DATA] ^ this.X2, this.wKey[103] ^ this.X3);
        LT();
        sb2(this.wKey[104] ^ this.X0, this.wKey[CipherSuite.TLS_DH_RSA_WITH_AES_256_CBC_SHA256] ^ this.X1, this.wKey[106] ^ this.X2, this.wKey[107] ^ this.X3);
        LT();
        sb3(this.wKey[108] ^ this.X0, this.wKey[109] ^ this.X1, this.wKey[EACTags.APPLICATION_RELATED_DATA] ^ this.X2, this.wKey[EACTags.FCI_TEMPLATE] ^ this.X3);
        LT();
    ...
    private int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        if (length == 0) {
            ...
            obj2[98] = this.X2;
            obj2[99] = this.X3;
            sb2(obj2[100], obj2[EACTags.CARDHOLDER_RELATIVE_DATA], obj2[EACTags.CARD_DATA], obj2[103]);
            obj2[100] = this.X0;
            obj2[EACTags.CARDHOLDER_RELATIVE_DATA] = this.X1;
            obj2[EACTags.CARD_DATA] = this.X2;
            obj2[103] = this.X3;
            sb1(obj2[104], obj2[CipherSuite.TLS_DH_RSA_WITH_AES_256_CBC_SHA256], obj2[106], obj2[107]);
            obj2[104] = this.X0;
            obj2[CipherSuite.TLS_DH_RSA_WITH_AES_256_CBC_SHA256] = this.X1;
            obj2[106] = this.X2;
            obj2[107] = this.X3;
            sb0(obj2[108], obj2[109], obj2[EACTags.APPLICATION_RELATED_DATA], obj2[EACTags.FCI_TEMPLATE]);
            obj2[108] = this.X0;
            obj2[109] = this.X1;
