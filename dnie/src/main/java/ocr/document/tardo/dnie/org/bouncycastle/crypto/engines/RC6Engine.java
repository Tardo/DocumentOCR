...
public class RC6Engine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (bytesToWord >= 1) {
            ...
            int rotateLeft2 = rotateLeft(((bytesToWord3 * 2) + 1) * bytesToWord3, 5);
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        i4 = i5;
        while (i3 <= 20) {
            int rotateLeft = rotateLeft(((bytesToWord * 2) + 1) * bytesToWord, 5);
            int rotateLeft2 = rotateLeft(((bytesToWord2 * 2) + 1) * bytesToWord2, 5);
