...
public class PKCS12Example {
    ...
    public static Certificate createCert(PublicKey publicKey, PrivateKey privateKey, PublicKey publicKey2) throws Exception {
        ...
        hashtable2.put(X509Principal.C, "AU");
        hashtable2.put(X509Principal.O, "The Legion of the Bouncy Castle");
        hashtable2.put(X509Principal.L, "Melbourne");
        hashtable2.put(X509Principal.CN, "Eric H. Echidna");
        hashtable2.put(X509Principal.EmailAddress, "feedback-crypto@bouncycastle.org");
        vector2.addElement(X509Principal.C);
        vector2.addElement(X509Principal.O);
        vector2.addElement(X509Principal.L);
        vector2.addElement(X509Principal.CN);
        vector2.addElement(X509Principal.EmailAddress);
        v3CertGen.reset();
        ...
        v3CertGen.addExtension(X509Extensions.AuthorityKeyIdentifier, false, new AuthorityKeyIdentifierStructure(publicKey2));
        Certificate generate = v3CertGen.generate(privateKey);
    ...
    public static Certificate createMasterCert(PublicKey publicKey, PrivateKey privateKey) throws Exception {
        ...
        Certificate generate = v1CertGen.generate(privateKey);
        generate.checkValidity(new Date());
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        KeySpec rSAPublicKeySpec2 = new RSAPublicKeySpec(new BigInteger("", 16), new BigInteger("ffff", 16));
