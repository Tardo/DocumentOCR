...
public class NoticeReference extends ASN1Object {
    ...
    private static ASN1EncodableVector convertVector(Vector vector) {
        ...
        while (elements.hasMoreElements()) {
            ...
            if (nextElement instanceof BigInteger) {
                ...
                nextElement = new ASN1Integer((long) ((Integer) nextElement).intValue());
            } else {
    ...
    public static NoticeReference getInstance(Object obj) {
        return obj instanceof NoticeReference ? (NoticeReference) obj : obj != null ? new NoticeReference(ASN1Sequence.getInstance(obj)) : null;
    }
