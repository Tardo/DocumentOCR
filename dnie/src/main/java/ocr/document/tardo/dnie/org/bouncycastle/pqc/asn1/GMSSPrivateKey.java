...
public class GMSSPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        for (i = 0; i < treehashArr.length; i++) {
            int i7 = 0;
            while (i7 < treehashArr[i].length) {
                aSN1EncodableVector4.add(new DERSequence(algorithmIdentifierArr[0]));
                int i8 = treehashArr[i][i7].getStatInt()[1];
                aSN1EncodableVector7.add(new DEROctetString(treehashArr[i][i7].getStatByte()[0]));
                aSN1EncodableVector7.add(new DEROctetString(treehashArr[i][i7].getStatByte()[1]));
                aSN1EncodableVector7.add(new DEROctetString(treehashArr[i][i7].getStatByte()[2]));
                for (i4 = 0; i4 < i8; i4++) {
                    aSN1EncodableVector7.add(new DEROctetString(treehashArr[i][i7].getStatByte()[i4 + 3]));
                }
                aSN1EncodableVector4.add(new DERSequence(aSN1EncodableVector7));
                aSN1EncodableVector = new ASN1EncodableVector();
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[0]));
                aSN1EncodableVector3.add(new ASN1Integer((long) i8));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[2]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[3]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[4]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[5]));
                for (i3 = 0; i3 < i8; i3++) {
                    aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr[i][i7].getStatInt()[i3 + 6]));
                }
                aSN1EncodableVector4.add(new DERSequence(aSN1EncodableVector3));
        ...
        for (i = 0; i < treehashArr2.length; i++) {
            i7 = 0;
            while (i7 < treehashArr2[i].length) {
                aSN1EncodableVector4.add(new DERSequence(algorithmIdentifierArr[0]));
                i8 = treehashArr2[i][i7].getStatInt()[1];
                aSN1EncodableVector7.add(new DEROctetString(treehashArr2[i][i7].getStatByte()[0]));
                aSN1EncodableVector7.add(new DEROctetString(treehashArr2[i][i7].getStatByte()[1]));
                aSN1EncodableVector7.add(new DEROctetString(treehashArr2[i][i7].getStatByte()[2]));
                for (i4 = 0; i4 < i8; i4++) {
                    aSN1EncodableVector7.add(new DEROctetString(treehashArr2[i][i7].getStatByte()[i4 + 3]));
                }
                aSN1EncodableVector4.add(new DERSequence(aSN1EncodableVector7));
                aSN1EncodableVector = new ASN1EncodableVector();
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[0]));
                aSN1EncodableVector3.add(new ASN1Integer((long) i8));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[2]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[3]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[4]));
                aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[5]));
                for (i3 = 0; i3 < i8; i3++) {
                    aSN1EncodableVector3.add(new ASN1Integer((long) treehashArr2[i][i7].getStatInt()[i3 + 6]));
                }
                aSN1EncodableVector4.add(new DERSequence(aSN1EncodableVector3));
                aSN1EncodableVector7 = new ASN1EncodableVector();
                aSN1EncodableVector6.add(new DERSequence(aSN1EncodableVector4));
        ...
        for (i5 = 0; i5 < vectorArr.length; i5++) {
            for (i22 = 0; i22 < vectorArr[i5].size(); i22++) {
                aSN1EncodableVector7.add(new DEROctetString((byte[]) vectorArr[i5].elementAt(i22)));
            }
        ...
        aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector7 = aSN1EncodableVector3;
        for (i5 = 0; i5 < vectorArr2.length; i5++) {
            for (i22 = 0; i22 < vectorArr2[i5].size(); i22++) {
                aSN1EncodableVector7.add(new DEROctetString((byte[]) vectorArr2[i5].elementAt(i22)));
            }
            aSN1EncodableVector6.add(new DERSequence(aSN1EncodableVector7));
            aSN1EncodableVector7 = new ASN1EncodableVector();
        }
        ...
        aSN1EncodableVector7 = aSN1EncodableVector3;
        i5 = 0;
        while (i5 < vectorArr3.length) {
            aSN1EncodableVector4 = aSN1EncodableVector8;
            for (i6 = 0; i6 < vectorArr3[i5].length; i6++) {
                for (i7 = 0; i7 < vectorArr3[i5][i6].size(); i7++) {
                    aSN1EncodableVector4.add(new DEROctetString((byte[]) vectorArr3[i5][i6].elementAt(i7)));
                }
        ...
        aSN1EncodableVector7 = aSN1EncodableVector3;
        i5 = 0;
        while (i5 < vectorArr4.length) {
            aSN1EncodableVector4 = aSN1EncodableVector8;
            for (i6 = 0; i6 < vectorArr4[i5].length; i6++) {
                for (i7 = 0; i7 < vectorArr4[i5][i6].size(); i7++) {
                    aSN1EncodableVector4.add(new DEROctetString((byte[]) vectorArr4[i5][i6].elementAt(i7)));
                }
                aSN1EncodableVector7.add(new DERSequence(aSN1EncodableVector4));
                aSN1EncodableVector4 = new ASN1EncodableVector();
            }
        ...
        while (i5 < gMSSRootCalcArr.length) {
            aSN1EncodableVector.add(new DERSequence(algorithmIdentifierArr[0]));
            aSN1EncodableVector10 = new ASN1EncodableVector();
            int i9 = gMSSRootCalcArr[i5].getStatInt()[0];
            i8 = gMSSRootCalcArr[i5].getStatInt()[7];
            aSN1EncodableVector6.add(new DEROctetString(gMSSRootCalcArr[i5].getStatByte()[0]));
            for (i7 = 0; i7 < i9; i7++) {
                aSN1EncodableVector6.add(new DEROctetString(gMSSRootCalcArr[i5].getStatByte()[i7 + 1]));
            }
            for (i7 = 0; i7 < i8; i7++) {
                aSN1EncodableVector6.add(new DEROctetString(gMSSRootCalcArr[i5].getStatByte()[(i9 + 1) + i7]));
            }
            aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector6));
            aSN1EncodableVector10 = new ASN1EncodableVector();
            aSN1EncodableVector4.add(new ASN1Integer((long) i9));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[1]));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[2]));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[3]));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[4]));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[5]));
            aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[6]));
            aSN1EncodableVector4.add(new ASN1Integer((long) i8));
            for (i6 = 0; i6 < i9; i6++) {
                aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[i6 + 8]));
            }
            for (i6 = 0; i6 < i8; i6++) {
                aSN1EncodableVector4.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getStatInt()[(i9 + 8) + i6]));
            }
            ...
            aSN1EncodableVector5 = new ASN1EncodableVector();
            if (gMSSRootCalcArr[i5].getTreehash() != null) {
                for (i222 = 0; i222 < gMSSRootCalcArr[i5].getTreehash().length; i222++) {
                    int i10;
                    aSN1EncodableVector12.add(new DERSequence((ASN1Encodable) algorithmIdentifierArr[0]));
                    int i11 = gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[1];
                    aSN1EncodableVector13.add(new DEROctetString(gMSSRootCalcArr[i5].getTreehash()[i222].getStatByte()[0]));
                    aSN1EncodableVector13.add(new DEROctetString(gMSSRootCalcArr[i5].getTreehash()[i222].getStatByte()[1]));
                    aSN1EncodableVector13.add(new DEROctetString(gMSSRootCalcArr[i5].getTreehash()[i222].getStatByte()[2]));
                    for (i10 = 0; i10 < i11; i10++) {
                        aSN1EncodableVector13.add(new DEROctetString(gMSSRootCalcArr[i5].getTreehash()[i222].getStatByte()[i10 + 3]));
                    }
                    aSN1EncodableVector12.add(new DERSequence(aSN1EncodableVector13));
                    aSN1EncodableVector13 = new ASN1EncodableVector();
                    aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[0]));
                    aSN1EncodableVector5.add(new ASN1Integer((long) i11));
                    aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[2]));
                    aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[3]));
                    aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[4]));
                    aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[5]));
                    for (i10 = 0; i10 < i11; i10++) {
                        aSN1EncodableVector5.add(new ASN1Integer((long) gMSSRootCalcArr[i5].getTreehash()[i222].getStatInt()[i10 + 6]));
                    }
            ...
            aSN1EncodableVector4 = new ASN1EncodableVector();
            aSN1EncodableVector5 = new ASN1EncodableVector();
            if (gMSSRootCalcArr[i5].getRetain() != null) {
                aSN1EncodableVector13 = aSN1EncodableVector5;
                for (i9 = 0; i9 < gMSSRootCalcArr[i5].getRetain().length; i9++) {
                    for (int i12 = 0; i12 < gMSSRootCalcArr[i5].getRetain()[i9].size(); i12++) {
                        aSN1EncodableVector13.add(new DEROctetString((byte[]) gMSSRootCalcArr[i5].getRetain()[i9].elementAt(i12)));
                    }
