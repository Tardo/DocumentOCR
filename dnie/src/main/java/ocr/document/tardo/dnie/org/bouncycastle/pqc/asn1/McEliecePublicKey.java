...
public class McEliecePublicKey extends ASN1Object {
    ...
    private McEliecePublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f528n = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
        this.f529t = ((ASN1Integer) aSN1Sequence.getObjectAt(2)).getValue().intValue();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer((long) this.f528n));
        aSN1EncodableVector.add(new ASN1Integer((long) this.f529t));
