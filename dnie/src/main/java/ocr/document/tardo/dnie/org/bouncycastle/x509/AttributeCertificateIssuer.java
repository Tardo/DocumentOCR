...
public class AttributeCertificateIssuer implements CertSelector, Selector {
    ...
    public AttributeCertificateIssuer(X509Principal x509Principal) {
        this.form = new V2Form(GeneralNames.getInstance(new DERSequence(new GeneralName((X509Name) x509Principal))));
    }
    ...
    public boolean match(Certificate certificate) {
        ...
        if (this.form instanceof V2Form) {
            ...
            if (v2Form.getBaseCertificateID() != null) {
                boolean z = v2Form.getBaseCertificateID().getSerial().getValue().equals(x509Certificate.getSerialNumber()) && matchesDN(x509Certificate.getIssuerX500Principal(), v2Form.getBaseCertificateID().getIssuer());
                return z;
            }
