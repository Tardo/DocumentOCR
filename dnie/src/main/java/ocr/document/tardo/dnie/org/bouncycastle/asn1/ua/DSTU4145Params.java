...
public class DSTU4145Params extends ASN1Object {
    ...
    public static DSTU4145Params getInstance(Object obj) {
        ...
        if (obj != null) {
            ...
            DSTU4145Params dSTU4145Params = instance.getObjectAt(0) instanceof ASN1ObjectIdentifier ? new DSTU4145Params(DERObjectIdentifier.getInstance(instance.getObjectAt(0))) : new DSTU4145Params(DSTU4145ECBinary.getInstance(instance.getObjectAt(0)));
            if (instance.size() == 2) {
