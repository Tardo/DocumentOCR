...
public class ECDSAPublicKey extends PublicKeyDataObject {
    /* renamed from: A */
    private static final int f615A = 2;
    /* renamed from: B */
    private static final int f616B = 4;
    /* renamed from: F */
    private static final int f617F = 64;
    /* renamed from: G */
    private static final int f618G = 8;
    /* renamed from: P */
    private static final int f619P = 1;
    /* renamed from: R */
    private static final int f620R = 16;
    /* renamed from: Y */
    private static final int f621Y = 32;
    ...
    ECDSAPublicKey(ASN1Sequence aSN1Sequence) throws IllegalArgumentException {
        ...
        if (this.options != 32 && this.options != CertificateBody.profileType) {
    ...
    public byte[] getBasePointG() {
        return (this.options & 8) != 0 ? this.basePointG : null;
    }
    ...
    public byte[] getPublicPointY() {
        return (this.options & 32) != 0 ? this.publicPointY : null;
    }
