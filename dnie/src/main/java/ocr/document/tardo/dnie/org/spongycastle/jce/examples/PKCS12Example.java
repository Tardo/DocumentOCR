...
public class PKCS12Example {
    ...
    public static Certificate createMasterCert(PublicKey pubKey, PrivateKey privKey) throws Exception {
        ...
        cert.verify(pubKey);
        ((PKCS12BagAttributeCarrier) cert).setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Bouncy Primary Certificate"));
        return cert;
    }
    ...
    public static Certificate createIntermediateCert(PublicKey pubKey, PrivateKey caPrivKey, X509Certificate caCert) throws Exception {
        ...
        ((PKCS12BagAttributeCarrier) cert).setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Bouncy Intermediate Certificate"));
        return cert;
    }
    ...
    public static Certificate createCert(PublicKey pubKey, PrivateKey caPrivKey, PublicKey caPubKey) throws Exception {
        ...
        bagAttr.setBagAttribute(PKCSObjectIdentifiers.pkcs_9_at_friendlyName, new DERBMPString("Eric's Key"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        rSAPublicKeySpec = new RSAPublicKeySpec(new BigInteger("", 16), new BigInteger("ffff", 16));
        ...
        rSAPublicKeySpec = new RSAPublicKeySpec(new BigInteger("", 16), new BigInteger("11", 16));
        ...
        PublicKey caPubKey = fact.generatePublic(rSAPublicKeySpec);
        PrivateKey intPrivKey = fact.generatePrivate(intPrivKeySpec);
        PublicKey intPubKey = fact.generatePublic(rSAPublicKeySpec);
        ...
        store.store(fileOutputStream, passwd);
