...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f48b;
    private final Digest digest;
    /* renamed from: g */
    private final BigInteger f49g;
    private BigInteger gx1;
    private BigInteger gx2;
    private BigInteger gx3;
    private BigInteger gx4;
    /* renamed from: p */
    private final BigInteger f50p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;
    /* renamed from: q */
    private final BigInteger f51q;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f50p = jPAKEPrimeOrderGroup.getP();
        this.f51q = jPAKEPrimeOrderGroup.getQ();
        this.f49g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        if (this.state >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f50p, this.f51q, this.gx4, this.x2, calculateS, this.f48b);
            this.x1 = null;
            this.x2 = null;
            this.f48b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.x1 = JPAKEUtil.generateX1(this.f51q, this.random);
        this.x2 = JPAKEUtil.generateX2(this.f51q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f50p, this.f49g, this.x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f50p, this.f49g, this.x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f50p, this.f51q, this.f49g, this.gx1, this.x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f50p, this.f51q, this.f49g, this.gx2, this.x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        if (this.state >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f50p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f51q, this.x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f50p, this.f51q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f50p, this.f51q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f50p, this.f51q, this.f49g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f50p, this.f51q, this.f49g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        if (this.state >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f50p, this.gx3, this.gx1, this.gx2);
            this.f48b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f50p, this.f51q, calculateGA, this.f48b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
