...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void addSeedMaterial(byte[] bArr) {
        for (byte b : bArr) {
            this.f292s = this.f290P[((this.f292s + this.f290P[this.f291n & 255]) + b) & 255];
            byte b2 = this.f290P[this.f291n & 255];
            this.f290P[this.f291n & 255] = this.f290P[this.f292s & 255];
            this.f290P[this.f292s & 255] = b2;
            this.f291n = (byte) ((this.f291n + 1) & 255);
        }
    }
    ...
    public void nextBytes(byte[] bArr, int i, int i2) {
        synchronized (this.f290P) {
            int i3 = i + i2;
            while (i != i3) {
                this.f292s = this.f290P[(this.f292s + this.f290P[this.f291n & 255]) & 255];
                bArr[i] = this.f290P[(this.f290P[this.f290P[this.f292s & 255] & 255] + 1) & 255];
                byte b = this.f290P[this.f291n & 255];
                this.f290P[this.f291n & 255] = this.f290P[this.f292s & 255];
                this.f290P[this.f292s & 255] = b;
                this.f291n = (byte) ((this.f291n + 1) & 255);
                i++;
            }
        }
