    ...
    public static PathProcInput getInstance(Object obj) {
        ...
        for (int i = 1; i < instance.size(); i++) {
            ...
            if (objectAt instanceof ASN1Boolean) {
                pathProcInput.setInhibitPolicyMapping(DERBoolean.getInstance((Object) objectAt).isTrue());
                ...
                switch (instance2.getTagNo()) {
                    case 0:
                        pathProcInput.setExplicitPolicyReqd(DERBoolean.getInstance(instance2, false).isTrue());
                        break;
                    case 1:
                        pathProcInput.setInhibitAnyPolicy(DERBoolean.getInstance(instance2, false).isTrue());
                        break;
                    default:
                        break;
                }
