...
public class Layer {
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        for (i3 = 0; i3 < i5; i3++) {
            int i6;
            for (i6 = 0; i6 < this.oi; i6++) {
                int i7;
                for (i7 = 0; i7 < this.vi; i7++) {
                    this.coeff_alpha[i3][i6][i7] = (short) (secureRandom.nextInt() & 255);
                }
            }
        }
        for (i3 = 0; i3 < i5; i3++) {
            for (i6 = 0; i6 < this.vi; i6++) {
                for (i7 = 0; i7 < this.vi; i7++) {
                    this.coeff_beta[i3][i6][i7] = (short) (secureRandom.nextInt() & 255);
                }
            }
        }
        for (i7 = 0; i7 < i5; i7++) {
            for (i6 = 0; i6 < this.viNext; i6++) {
                this.coeff_gamma[i7][i6] = (short) (secureRandom.nextInt() & 255);
            }
        }
        while (i4 < i5) {
            this.coeff_eta[i4] = (short) (secureRandom.nextInt() & 255);
            i4++;
        }
    }
