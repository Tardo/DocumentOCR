    ...
    public X9Curve(X9FieldID x9FieldID, ASN1Sequence aSN1Sequence) {
        ...
        if (this.fieldIdentifier.equals(prime_field)) {
            ...
            if (aSN1ObjectIdentifier.equals(tpBasis)) {
                intValue = DERInteger.getInstance(instance.getObjectAt(2)).getValue().intValue();
                i = 0;
                i2 = 0;
            } else if (aSN1ObjectIdentifier.equals(ppBasis)) {
                ASN1Sequence instance2 = ASN1Sequence.getInstance(instance.getObjectAt(2));
                intValue = DERInteger.getInstance(instance2.getObjectAt(0)).getValue().intValue();
                i2 = DERInteger.getInstance(instance2.getObjectAt(1)).getValue().intValue();
                i = DERInteger.getInstance(instance2.getObjectAt(2)).getValue().intValue();
            } else {
            ...
            this.curve = new F2m(intValue2, intValue, i2, i, x9FieldElement.getValue().toBigInteger(), x9FieldElement2.getValue().toBigInteger());
        } else {
