...
public abstract class LongDigest implements ExtendedDigest, Memoable {
    ...
    protected void copyIn(LongDigest longDigest) {
        ...
        System.arraycopy(longDigest.f489W, 0, this.f489W, 0, longDigest.f489W.length);
    ...
    protected void processBlock() {
        ...
        adjustByteCounts();
        for (i = 16; i <= 79; i++) {
            this.f489W[i] = ((Sigma1(this.f489W[i - 2]) + this.f489W[i - 7]) + Sigma0(this.f489W[i - 15])) + this.f489W[i - 16];
        }
        long j = this.H1;
        long j2 = this.H2;
        long j3 = this.H3;
        ...
        while (i < 10) {
            int i3 = i2 + 1;
            j8 += this.f489W[i2] + ((Sum1(j5) + Ch(j5, j6, j7)) + f488K[i2]);
            j4 += j8;
            j = (Maj(j9, j2, j3) + Sum0(j9)) + j8;
            int i4 = i3 + 1;
            long Ch = j7 + (((Ch(j4, j5, j6) + Sum1(j4)) + f488K[i3]) + this.f489W[i3]);
            j8 = j3 + Ch;
            j7 = (Maj(j, j9, j2) + Sum0(j)) + Ch;
            int i5 = i4 + 1;
            long Ch2 = j6 + (((Ch(j8, j4, j5) + Sum1(j8)) + f488K[i4]) + this.f489W[i4]);
            j3 = j2 + Ch2;
            j6 = (Maj(j7, j, j9) + Sum0(j7)) + Ch2;
            int i6 = i5 + 1;
            Ch2 = j5 + (((Ch(j3, j8, j4) + Sum1(j3)) + f488K[i5]) + this.f489W[i5]);
            j2 = j9 + Ch2;
            j5 = (Maj(j6, j7, j) + Sum0(j6)) + Ch2;
            i5 = i6 + 1;
            j4 += ((Ch(j2, j3, j8) + Sum1(j2)) + f488K[i6]) + this.f489W[i6];
            j9 = j + j4;
            j4 += Sum0(j5) + Maj(j5, j6, j7);
            i3 = i5 + 1;
            long Ch3 = j8 + (((Ch(j9, j2, j3) + Sum1(j9)) + f488K[i5]) + this.f489W[i5]);
            j = j7 + Ch3;
            j8 = Ch3 + (Sum0(j4) + Maj(j4, j5, j6));
            i4 = i3 + 1;
            long Ch4 = j3 + (((Ch(j, j9, j2) + Sum1(j)) + f488K[i3]) + this.f489W[i3]);
            j7 = j6 + Ch4;
            j3 = Ch4 + (Sum0(j8) + Maj(j8, j4, j5));
            int i7 = i4 + 1;
            j6 = (((Ch(j7, j, j9) + Sum1(j7)) + f488K[i4]) + this.f489W[i4]) + j2;
            j5 += j6;
    ...
    protected void processWord(byte[] bArr, int i) {
        this.f489W[this.wOff] = Pack.bigEndianToLong(bArr, i);
        int i2 = this.wOff + 1;
        this.wOff = i2;
        if (i2 == 16) {
            processBlock();
