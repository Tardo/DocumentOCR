...
public final class BigEndianConversions {
    ...
    public static int OS2IP(byte[] bArr, int i, int i2) {
        ...
        if (bArr.length != 0 && bArr.length >= (i + i2) - 1) {
            int i4 = 0;
            while (i4 < i2) {
                int i5 = ((bArr[i + i4] & 255) << (((i2 - i4) - 1) * 8)) | i3;
                i4++;
                i3 = i5;
            }
        }
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        i2 = i3 + 1;
        i3 = i2 + 1;
        return ((long) (bArr[i3 + 1] & 255)) | ((((((((((long) bArr[i]) & 255) << 56) | ((((long) bArr[i2]) & 255) << 48)) | ((((long) bArr[i3]) & 255) << 40)) | ((((long) bArr[i2]) & 255) << 32)) | ((((long) bArr[i3]) & 255) << 24)) | ((long) ((bArr[i2] & 255) << 16))) | ((long) ((bArr[i3] & 255) << 8)));
    }
