        ...
        if (!(key instanceof SecretKey)) {
            ...
            if (key instanceof BCPBEKey) {
                ...
                if (gOST28147ParameterSpec.getIV() == null || this.ivLength == 0) {
                    ...
                    parametersWithIV = new ParametersWithIV(r2, gOST28147ParameterSpec.getIV());
                    this.ivParam = parametersWithIV;
                }
                r0 = parametersWithIV;
            ...
            if (!(this.ivLength == 0 || (param instanceof ParametersWithIV))) {
                ...
                if (i == 1 || i == 3) {
                    ...
                    cipherParameters = new ParametersWithIV(param, bArr);
                    this.ivParam = (ParametersWithIV) cipherParameters;
                    param = (secureRandom == null && this.padded) ? new ParametersWithRandom(cipherParameters, secureRandom) : cipherParameters;
                    switch (i) {
                        case 1:
                        case 3:
