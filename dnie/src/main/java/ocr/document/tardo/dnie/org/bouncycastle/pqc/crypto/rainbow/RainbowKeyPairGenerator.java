...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                ...
                for (i6 = 0; i6 < length2; i6++) {
                    for (i7 = 0; i7 < length2; i7++) {
                        ...
                        sArr[i3 + i5] = computeInField.addSquareMatrix(sArr[i3 + i5], computeInField.multVects(multVect, this.A2[i7]));
                        this.pub_singular[i3 + i5] = computeInField.addVect(computeInField.multVect(this.b2[i7], multVect), this.pub_singular[i3 + i5]);
                        this.pub_singular[i3 + i5] = computeInField.addVect(computeInField.multVect(this.b2[i6], computeInField.multVect(coeffBeta[i5][i6][i7], this.A2[i7])), this.pub_singular[i3 + i5]);
                        multElem = GF2Field.multElem(coeffBeta[i5][i6][i7], this.b2[i6]);
                        this.pub_scalar[i3 + i5] = GF2Field.addElem(this.pub_scalar[i3 + i5], GF2Field.multElem(multElem, this.b2[i7]));
                    }
                }
                for (i7 = 0; i7 < length2 + length; i7++) {
                    this.pub_singular[i3 + i5] = computeInField.addVect(computeInField.multVect(coeffGamma[i5][i7], this.A2[i7]), this.pub_singular[i3 + i5]);
    ...
    private void generateL1() {
        ...
        while (this.A1inv == null) {
            for (int i3 = 0; i3 < i2; i3++) {
                for (i = 0; i < i2; i++) {
                    this.A1[i3][i] = (short) (this.sr.nextInt() & 255);
                }
            }
    ...
    private void generateL2() {
        ...
        this.b2 = new short[i];
        for (i3 = 0; i3 < i; i3++) {
            this.b2[i3] = (short) (this.sr.nextInt() & 255);
        }
    }
