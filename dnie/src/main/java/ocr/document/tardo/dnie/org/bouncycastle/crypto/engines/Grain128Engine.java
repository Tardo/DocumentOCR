...
public class Grain128Engine implements StreamCipher {
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (i < this.nfsr.length) {
            this.nfsr[i] = (((this.workingKey[i2 + 3] << 24) | ((this.workingKey[i2 + 2] << 16) & 16711680)) | ((this.workingKey[i2 + 1] << 8) & 65280)) | (this.workingKey[i2] & 255);
            this.lfsr[i] = (((this.workingIV[i2 + 3] << 24) | ((this.workingIV[i2 + 2] << 16) & 16711680)) | ((this.workingIV[i2 + 1] << 8) & 65280)) | (this.workingIV[i2] & 255);
            i2 += 4;
            i++;
        }
    }
