...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    private static final String[] DIGESTS = new String[]{"GOST3411", "MD2", "MD4", "MD5", "SHA1", "RIPEMD128", "RIPEMD160", "RIPEMD256", "RIPEMD320", "SHA224", McElieceCCA2ParameterSpec.DEFAULT_MD, "SHA384", "SHA512", "SHA3", "Tiger", "Whirlpool"};
    private static final String DIGEST_PACKAGE = "org.bouncycastle.jcajce.provider.digest.";
    private static final String[] KEYSTORES = new String[]{PROVIDER_NAME, "PKCS12"};
    ...
    class C00951 implements PrivilegedAction {
        C00951() {
        }
    ...
    public BouncyCastleProvider() {
        ...
        AccessController.doPrivileged(new C00951());
    }
