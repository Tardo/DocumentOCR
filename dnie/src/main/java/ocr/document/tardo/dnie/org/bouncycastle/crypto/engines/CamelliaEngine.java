...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        i2 = SBOX1_1110[(i2 >>> 24) & 255] ^ ((SBOX4_4404[i2 & 255] ^ SBOX3_3033[(i2 >>> 8) & 255]) ^ SBOX2_0222[(i2 >>> 16) & 255]);
        int i3 = iArr[1] ^ iArr2[i + 1];
        i3 = SBOX2_0222[(i3 >>> 24) & 255] ^ ((SBOX1_1110[i3 & 255] ^ SBOX4_4404[(i3 >>> 8) & 255]) ^ SBOX3_3033[(i3 >>> 16) & 255]);
        iArr[2] = iArr[2] ^ (i2 ^ i3);
        iArr[3] = (rightRotate(i2, 8) ^ (i3 ^ i2)) ^ iArr[3];
        i2 = iArr[2] ^ iArr2[i + 2];
        i2 = SBOX1_1110[(i2 >>> 24) & 255] ^ ((SBOX4_4404[i2 & 255] ^ SBOX3_3033[(i2 >>> 8) & 255]) ^ SBOX2_0222[(i2 >>> 16) & 255]);
        i3 = iArr[3] ^ iArr2[i + 3];
        i3 = SBOX2_0222[(i3 >>> 24) & 255] ^ ((SBOX1_1110[i3 & 255] ^ SBOX4_4404[(i3 >>> 8) & 255]) ^ SBOX3_3033[(i3 >>> 16) & 255]);
        iArr[0] = iArr[0] ^ (i2 ^ i3);
        iArr[1] = (rightRotate(i2, 8) ^ (i3 ^ i2)) ^ iArr[1];
    }
